 ...
 *
 */
package com.hyk.proxy.client.gae.admin;
...
import com.hyk.proxy.client.gae.admin.handler.AddGroup;
import com.hyk.proxy.client.gae.admin.handler.AddUser;
import com.hyk.proxy.client.gae.admin.handler.Blacklist;
import com.hyk.proxy.client.gae.admin.handler.ChangePasswd;
import com.hyk.proxy.client.gae.admin.handler.ClearScreen;
import com.hyk.proxy.client.gae.admin.handler.CommandHandler;
import com.hyk.proxy.client.gae.admin.handler.DeleteGroup;
import com.hyk.proxy.client.gae.admin.handler.DeleteUser;
import com.hyk.proxy.client.gae.admin.handler.Exit;
import com.hyk.proxy.client.gae.admin.handler.Help;
import com.hyk.proxy.client.gae.admin.handler.ListGroups;
import com.hyk.proxy.client.gae.admin.handler.ListUsers;
import com.hyk.proxy.client.gae.admin.handler.Stat;
import com.hyk.proxy.client.gae.admin.handler.Traffic;
import com.hyk.proxy.client.util.ClientUtils;
import com.hyk.proxy.client.config.Config;
import com.hyk.proxy.client.config.Config.ConnectionMode; //import com.hyk.proxy.client.util.ClientUtils;
...
public class Admin
{
	...
	public void start() throws IOException, RpcException, XMPPException
	{
		...
		{
			RPC rpc = ClientUtils.createXmppRPC(config.getXmppAccounts().get(0), executor);
