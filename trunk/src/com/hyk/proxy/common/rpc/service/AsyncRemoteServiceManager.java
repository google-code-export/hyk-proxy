...
public interface AsyncRemoteServiceManager
{
	...
	public void getAccountService(User user, RpcCallback<AccountService> callback);

	public void getBandwidthStatisticsService(User user, RpcCallback<BandwidthStatisticsService> callback);
