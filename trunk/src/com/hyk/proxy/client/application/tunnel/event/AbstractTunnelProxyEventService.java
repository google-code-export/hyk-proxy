        ...
        HttpProxyEventService
{
	...
	class ForwardResponseHandler extends SimpleChannelUpstreamHandler
	{
		        ...
		        throws Exception
		{
			...
			if (null != listener)
			{
				listener.onEventServiceClose(AbstractTunnelProxyEventService.this);
			}
		}
...
//				}
	...
	@Override
	public void addHttpProxyEventServiceStateListener(
	        HttpProxyEventServiceStateListener listener)
	{
