		...
		switch(event.getType())
		{
			...
			case RECV_HTTPS_REQUEST:
			{
				...
				try
				{
					...
					{
						//request.setUri("http://" + request.getHeader(HttpHeaders.Names.HOST) + request.getUri());
						//request.
...
//			if(null != locaChannelFuture)
//			{
//				locaChannelFuture.addListener(ChannelFutureListener.CLOSE);
//			}
			//closeChannel(localChannel);
		}
