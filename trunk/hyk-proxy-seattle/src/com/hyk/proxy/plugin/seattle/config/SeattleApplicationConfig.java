 ...
 *
 */
package com.hyk.proxy.plugin.seattle.config;
...
public class SeattleApplicationConfig
{
	...
	private static void loadConfig()
	{
		try
		{
			...
			BufferedReader reader  = new BufferedReader(new InputStreamReader(SeattleApplicationConfig.class.getResourceAsStream("/seattle.conf")));
