 ...
 *
 */
package org.hyk.proxy.gae.client.util;
...
import org.hyk.proxy.gae.client.rpc.HttpClientRpcChannel;
import org.hyk.proxy.gae.client.rpc.XmppRpcChannel;
import org.hyk.proxy.gae.common.Constants;
import org.hyk.proxy.gae.common.http.header.SetCookieHeaderValue;
import org.hyk.proxy.gae.common.http.message.HttpMessageExhange;
...
//	}
	...
	public static boolean isHttpServerReachable(String appid, boolean viaGoogle) {
		...
		try {
			...
			} else if (GoogleAvailableService.getInstance()
					.getMappingHost(host) != host) {
				proxy = new Proxy(Type.HTTP, new InetSocketAddress(
